...
#include <atlstr.h>
#include <shlobj.h>
#define WIN_CHROMEPLUS_APP
#if defined(WIN_CHROMEPLUS_APP)
#include "chrome_proxy/chrome/chrome_exe_main_win.h"
#endif
...
extern "C"  int APIENTRY wWinMain(HINSTANCE instance,
                                 HINSTANCE prev,
                                 wchar_t*,
                                 int nShowCmd) {
#else
...
#if defined(WIN_CHROMEPLUS_APP)
    switch (theApp.PreMessageLoop(nShowCmd)) {
      case -2018:
        return -1;
        break;
      case 20180915:
