...
IPC_MESSAGE_ROUTED3(FrameHostMsg_TangramExtend,
                    std::wstring /* xml */,
                    std::wstring /* key */,
                    std::wstring /* features */)
IPC_MESSAGE_ROUTED3(FrameMsg_InternalIPCMsg,
                    std::wstring /* type */,
                    std::wstring /* xml */,
                    std::wstring /* data */)
IPC_MESSAGE_ROUTED3(FrameMsg_WndNodeIPCMsg,
                    __int64 /* HWND */,
                    std::wstring /* xml */,
                    std::wstring /* data */)
IPC_MESSAGE_ROUTED3(FrameHostMsg_ExternalIPCMsg,
                    std::wstring /* type */,
                    std::wstring /* key */,
                    std::wstring /* data */)
IPC_MESSAGE_ROUTED2(FrameMsg_IPCMsg,
