...
class CONTENT_EXPORT RenderFrameImpl
 ...
 public:
  ...
  void OnTangramExtend(std::wstring strXml,
                       std::wstring strKey,
                       std::wstring strFeatures) override;
  void ExternalSend(std::wstring strType,
                    std::wstring strKey,
                    std::wstring strData) override;
  void SendNodeMessage(__int64 nHandle,
                       std::wstring strXml,
                       std::wstring strData) override;
  void sendMessage(std::wstring strContent, void*, void*) override;
  void OnInternalIPCMsg(std::wstring strType,
                        std::wstring strKey,
                        std::wstring strData);
