...
class CONTENT_EXPORT RenderFrameHostImpl :
      // begin Add by TangramTeam
      public ChromePlus::CChromeRenderFrameHostBase,
      // end Add by TangramTeam
 ...
 private:
  ...
  // begin Add by TangramTeam
  void OnTangramExtend(std::wstring xml,
                       std::wstring key,
                       std::wstring features);
  void OnExternalIPCMsg(std::wstring strType,
                        std::wstring strKey,
                        std::wstring strData);
  void OnWndNodeIPCMsg(__int64 nHandle,
                       std::wstring strKey,
                       std::wstring strData);
  std::string Get_LastCommittedURL() override;
  void OnSetFocusedFrame() override;
  void InternalSend(ChromePlus::IPCMsg*) override;
  void OnIPCMessageReceived(std::wstring strContent,
  ...
  void OpenURLWithID(std::wstring strUrl,
                     BrowserWndOpenDisposition nPos,
                     std::wstring strWorkspaceID,
                     std::wstring strRegionID) override;
  // end Add by TangramTeam
